...
tools: Bash, Glob, Grep, Read, mcp__knowledge_search__search_and_fetch, mcp__knowledge_search__extract_article_llm_metadata, mcp__knowledge_search__get_article_full_text, mcp__knowledge_search__list_pmc_archive, mcp__knowledge_search__download_pxd, mcp__knowledge_search__download_ipx, mcp__knowledge_search__download_from_urls, mcp__knowledge_search__get_pxd_size, mcp__mcp_common__validate_article, mcp__mcp_common__validate_articles_from_db, mcp__mcp_common__fetch_crossref_metadata, mcp__mcp_common__fetch_pubmed_metadata
color: green
---
